...
namespace Google.XR.Cardboard
{
	...
	public static class Api
    {
        ...
        public static bool IsCloseButtonPressed
        {
            get
            {
                if (!XRLoader._isStarted || (Touchscreen.current == null) || !Touchscreen.current.IsPressed())
                {
                    return false;
                }
                return Widget.CloseButtonRect.Contains(GetTouchPosition());
            }
        }
        ...
        public static bool IsGearButtonPressed
        {
            get
            {
                ...
                return Widget.GearButtonRect.Contains(GetTouchPosition());
            }
        }
        ...
        public static bool IsTriggerHeldPressed
        {
            get
            {
                if (!XRLoader._isStarted || (Touchscreen.current == null) || (Touchscreen.current.touches.Count > 0))
                {
                    return false;
                }
                ...
                else if ((touch.phase.ReadValue() == UnityEngine.InputSystem.TouchPhase.Ended) && _touchStarted)
                {
