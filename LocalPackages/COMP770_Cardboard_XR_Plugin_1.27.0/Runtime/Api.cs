...
namespace Google.XR.Cardboard
{
    ...
    public static class Api
    {
        ...
        {
            if (!IsCardboardXRLoaderInitialized()) return;
        ...
        /// <summary>
        /// Checks if the cardboard XR loader has been initialized and prints a warning once (if not in editor mode).
        /// </summary>
        ///
        /// <returns>
        /// <code>true</code> if cardboard loader has been initialised.
        /// </returns>
        private static bool IsCardboardXRLoaderInitialized()
        {
            if (XRLoader._isInitialized) return true;
        ...
        [DllImport(ApiConstants.CardboardApi)]
        private static extern void CardboardUnity_setHeadTrackerLowPassFilter(int velocity_filter_cutoff_frequency);
    }
}
